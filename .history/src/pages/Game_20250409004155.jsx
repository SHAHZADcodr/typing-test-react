...
const Game = () => {
  ...
  const endGame = () => {
    ...
    const resultData = { score, missed, accuracy, wpm, total };
    console.log("Saving result to localStorage:", resultData); // DEBUG
   localStorage.setItem(
  'gameResult',
  JSON.stringify({ score, missed, accuracy, wpm, total })
);
navigate('/gameover');
localStorage.setItem(
  'gameResult',
