  ...
  useEffect(() => {
    const falling = setInterval(() => {
      setWords((prevWords) => {
        ...
        // Only update missed count if it hasn't been updated already for this interval
        if (missedWords.length > 0) {
          setMissed((prev) => prev + missedCountInInterval.current);
        missedCountInInterval.current = 0; // Reset the count for next interval setMissed((prev) => prev + missedCountInInterval.current);
