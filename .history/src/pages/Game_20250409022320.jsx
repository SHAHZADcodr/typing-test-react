...
const wordBank = {
  easy: [  'apple', 'ball', 'cat', 'dog', 'egg', 'fish', 'grape', 'hat', 'ice', 'juice',
    'kite', 'lemon', 'moon', 'nest', 'orange', 'piano', 'queen', 'rabbit', 'sun', 'tree',
    'umbrella', 'violin', 'whale', 'xylophone', 'yogurt', 'zebra', 'ant', 'book', 'chair', 'desk',
    'elephant', 'flower', 'garden', 'house', 'island', 'jacket', 'key', 'lamp', 'mountain', 'notebook',
    'ocean', 'pencil', 'quilt', 'rainbow', 'star', 'turtle', 'uniform', 'volcano', 'window', 'x-ray',
    'yellow', 'zipper', 'angel', 'banana', 'cloud', 'dolphin', 'engine', 'feather', 'guitar', 'hammer',
    ...],
