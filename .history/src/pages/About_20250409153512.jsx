  ...
  return (
    <Container className="about-container">
      <Card className="about-card">
        ...
        <p>
          Welcome to our free <strong>Typing Test platform!</strong> website! This platform is built to help you practice typing, improve your speed, and track your progress over time.
        </p>
        <p>
