...
const wordBank = {
  ...
  medium: ['abase', 'abate', 'abdicate', 'aberration', 'abhor', 'abject', 'abjure', 'abnegation', 'abrogate', 'abscond', 'abstruse', 'accede', 'acerbic', 'acquiesce', 'acrimony', 'acumen', 'adumbrate', 'affluent', 'aggrandize', 'alacrity', 'alias', 'ambivalent', 'ameliorate', 'amenable', 'anachronistic', 'anathema', 'annex', 'antediluvian', 'antipathy', 'antithesis', 'apocryphal', 'approbation', 'arrogate', 'ascetic', 'aspersion', 'assiduous', 'atrophy', 'attenuate', 'audacious', 'augury', 'austere', 'avarice', 'baleful', 'banal', 'beguile', 'belie', 'belligerent', 'benevolent', 'benign', 'bequeath', 'berate', 'bereft', 'bifurcate', 'bilk', 'blandishment', 'bombastic', 'boon', 'bourgeois', 'bowdlerize', 'bucolic', 'burnish', 'buttress', 'cacophony', 'cajole', 'calumny', 'camaraderie', 'candor', 'capitulate', 'capricious', 'carp', 'catalyst', 'catharsis', 'caustic', 'censure', 'chagrin', 'charlatan', 'chicanery', 'chide', 'churlish', 'circuitous', 'circumlocution', 'circumscribe', 'circumvent', 'clandestine', 'clemency', 'coalesce', 'cogent', 'cognizant', 'commensurate', 'complement', 'compunction', 'concomitant', 'conflagration', 'confluence', 'congenial', 'congruity', 'connive', 'consign', 'constituent', 'construe', 'contumacious', 'conundrum', 'convivial', 'copious', 'corpulence', 'coterie', 'credulity', 'crescendo', 'culpable', 'cursory', 'curt', 'dearth', 'debacle', 'debunk', 'decorous', 'decry', 'defunct', 'deleterious', 'demagogue', 'demur', 'denigrate', 'denizen', 'deprecate', 'deride', 'despot', 'diaphanous', 'didactic', 'diffident', 'dilatory', 'diminutive', 'discomfit', 'discordant', 'disparate', 'dissemble', 'dissonance', 'divisive', 'dogmatic', 'dormant', 'dour', 'duplicity', 'ebullient', 'eclectic', 'edify', 'efface', 'effervescent', 'efficacious', 'effrontery', 'egregious', 'elicit', 'elucidate', 'emaciated', 'embellish', 'emend', 'emollient', 'empirical', 'encomium', 'enervate', 'engender', 'enmity', 'ennui', 'ephemeral', 'epistolary', 'equanimity', 'equivocal', 'erudite', 'eschew', 'esoteric', 'espouse', 'ethereal', 'evanescent', 'evince', 'exacerbate', 'exculpate', 'execrable', 'exigent', 'exonerate', 'expedient', 'expiate', 'expunge', 'extant', 'extol', 'extraneous', 'extrapolate', 'extricate', 'facetious', 'fallacious', 'fastidious', 'fatuous', 'fecund', 'felicitous', 'feral', 'fervent', 'fetid', 'flagrant', 'florid', 'fractious', 'garrulous', 'gourmand', 'grandiloquent', 'gregarious', 'hackneyed', 'hapless', 'harangue', 'hegemony', 'heterogeneous', 'hiatus', 'hierarchy', 'histrionic', 'homogeneous', 'hubris', 'hyperbole', 'iconoclast', 'idiosyncratic', 'idyllic', 'ignominious', 'illicit', 'imbroglio', 'immutable', 'impassive', 'impecunious', 'imperious', 'impetuous', 'impinge', 'implacable', 'impugn', 'inchoate', 'incontrovertible', 'incorrigible', 'indefatigable', 'indigent', 'indolent', 'ineffable', 'inexorable', 'ingenuous', 'inimical', 'iniquity', 'insidious', 'insipid', 'intransigent', 'intrepid', 'inure', 'invective', 'inveterate', 'irascible', 'itinerant', 'juxtaposition', 'laconic', 'languid', 'largess', 'latent', 'legerdemain', 'licentious', 'limpid', 'linchpin', 'lithe', 'loquacious', 'luminous', 'magnanimous', 'malevolent', 'malinger', 'malleable', 'mandate', 'manifest', 'maudlin', 'maverick', 'mawkish', 'maxim', 'mellifluous', 'mendacious', 'mercurial', 'meritorious', 'metamorphosis', 'meticulous', 'mitigate', 'modicum', 'morass', 'mores', 'munificent', 'myriad', 'nadir', 'nascent', 'nefarious', 'neophyte', 'noisome', 'noxious', 'obdurate', 'obfuscate', 'oblique', 'obsequious', 'obstreperous', 'obtuse', 'odious', 'officious', 'ominous', 'onerous', 'opulent', 'ostracism', 'palliate', 'panacea', 'paradigm', 'pariah', 'parsimony', 'pathos', 'paucity', 'pejorative', 'pellucid', 'penchant', 'penurious', 'perfidious', 'perfunctory', 'pernicious', 'perspicacious', 'pertinacious', 'phlegmatic', 'pithy', 'platitude', 'plethora', 'portent', 'precocious', 'predilection', 'preponderance', 'prescient', 'prevaricate', 'probity', 'proclivity', 'profligate', 'promulgate', 'propensity', 'propitious'],
  hard: ['algorithm', 'symphony', 'hypothesis', 'university', 'revolution','abscond', 'abstruse', 'acumen', 'adumbrate', 'aegis', 'aesthetic', 'affluent', 'aggrandize', 'alacrity', 'anachronistic', 'anathema', 'antediluvian', 'antipathy', 'apocryphal', 'approbation', 'arrogate', 'ascetic', 'aspersion', 'assiduous', 'asylum', 'attenuate', 'audacious', 'augury', 'austere', 'avarice', 'baleful', 'banal', 'beguile', 'belie', 'belligerent', 'benevolent', 'benign', 'bequeath', 'berate', 'bereft', 'bifurcate', 'bilk', 'blandishment', 'bombastic', 'boon', 'bourgeois', 'bowdlerize', 'bucolic', 'burnish', 'buttress', 'cacophony', 'cajole', 'calumny', 'camaraderie', 'candor', 'capitulate', 'capricious', 'carp', 'catalyst', 'catharsis', 'caustic', 'censure', 'chagrin', 'charlatan', 'chicanery', 'chide', 'churlish', 'circuitous', 'circumlocution', 'circumscribe', 'circumvent', 'clandestine', 'clemency', 'coalesce', 'cogent', 'cognizant', 'commensurate', 'complement', 'compunction', 'concomitant', 'conflagration', 'confluence', 'congenial', 'congruity', 'connive', 'consanguineous', 'consternation', 'construe', 'contumacious', 'conundrum', 'convivial', 'copious', 'corpulence', 'coterie', 'credulity', 'crescendo', 'culpable', 'cupidity', 'cursory', 'curt', 'cynosure', 'dearth', 'debacle', 'debauch', 'decorous', 'decry', 'defenestrate', 'deferential', 'deleterious', 'demagogue', 'demur', 'denigrate', 'denizen', 'deprecate', 'deride', 'despot', 'diaphanous', 'diatribe', 'dichotomy', 'dictum', 'didactic', 'diffident', 'dilatory', 'dilettante', 'dirge', 'disaffected', 'discursive', 'dissemble', 'dissonant', 'dissuade', 'divisive', 'dogmatic', 'dormant', 'dour', 'duplicity', 'ebullient', 'eclectic', 'edify', 'efface', 'effervescent', 'efficacious', 'effrontery', 'egregious', 'elicit', 'elucidate', 'emaciated', 'embellish', 'emollient', 'empirical', 'encomium', 'endemic', 'enervate', 'engender', 'enigma', 'ennui', 'ephemeral', 'epistolary', 'equanimity', 'equivocal', 'erudite', 'eschew', 'esoteric', 'espouse', 'ethereal', 'euphemism', 'evanescent', 'evince', 'exacerbate', 'exculpate', 'execrable', 'exigent', 'exonerate', 'expedient', 'expiate', 'expunge', 'extant', 'extol', 'extraneous', 'extrapolate', 'extricate', 'facetious', 'facile', 'fallacious', 'fastidious', 'fatuous', 'fecund', 'feign', 'felicitous', 'feral', 'fetter', 'florid', 'flout', 'foible', 'fortuitous', 'fractious', 'garrulous', 'gauche', 'germane', 'grandiloquence', 'gregarious', 'guile', 'hackneyed', 'hapless', 'harangue', 'hegemony', 'heterogeneous', 'hiatus', 'hierarchy', 'homogeneous', 'hubris', 'iconoclast', 'idiosyncratic', 'ignominious', 'illicit', 'imbroglio', 'immutable', 'impassive', 'impecunious', 'imperious', 'impetuous', 'impinge', 'implacable', 'impugn', 'inchoate', 'incontrovertible', 'inculcate', 'indefatigable', 'indigent', 'ineffable', 'inexorable', 'ingenuous', 'inimical', 'iniquity', 'insidious', 'insipid', 'intransigent', 'intrepid', 'inure', 'invective', 'inveterate', 'irascible', 'itinerant', 'juxtaposition', 'laconic', 'largess', 'latent', 'legerdemain', 'licentious', 'limpid', 'linchpin', 'lithe', 'loquacious', 'lucid', 'lurid', 'malediction', 'malevolent', 'malinger', 'malleable', 'manifold', 'maudlin', 'maverick', 'mawkish', 'mellifluous', 'mendacious', 'mercurial', 'meritorious', 'metamorphosis', 'meticulous', 'mitigate', 'modicum', 'mollify', 'morass', 'mores', 'munificent', 'myriad', 'nadir', 'nebulous', 'nefarious', 'neophyte', 'nocturnal', 'noisome', 'noxious', 'obdurate', 'obfuscate', 'oblique', 'obsequious', 'obstreperous', 'obtuse', 'odious', 'officious', 'onerous', 'opulent', 'ostracism', 'palliate', 'panacea', 'paradigm', 'paragon', 'pariah', 'parsimonious', 'partisan', 'patent', 'pejorative', 'pellucid', 'penchant', 'penurious', 'perfidious', 'perfunctory', 'pernicious', 'perspicacious', 'pertinacious', 'petulant', 'phlegmatic', 'pithy', 'platitude', 'plethora', 'polemic', 'portent', 'precocious', 'predilection', 'preponderance', 'prescient', 'prevaricate', 'probity', 'proclivity', 'profligate', 'promulgate', 'propensity', 'propitious', 'prosaic', 'protean', 'prurient']
};
...
const Game = () => {
  ...
  // Ref to track missed count without triggering re-renders
  const missedCountRef = useRef(0);
  const fallingIntervalRef = useRef(null);
  const updateMissedIntervalRef = useRef(null);
  ...
  useEffect(() => {
    ...
    if (updateMissedIntervalRef.current) clearInterval(updateMissedIntervalRef.current);
    ...
    fallingIntervalRef.current = setInterval(() => {
      setWords((prevWords) => {
        ...
        if (missedWords.length > 0) {
          missedCountRef.current += missedWords.length; // Increment missed count
          console.log("Missed:", missedWords);
        }
  
        // Return only words that are still visible
        return updated.filter((word) => word.top < 90);
      });
    }, 100);
  
    // Interval to update missed state
    updateMissedIntervalRef.current = setInterval(() => {
      if (missedCountRef.current > 0) {
        setMissed((prev) => prev + missedCountRef.current); // Update state
        missedCountRef.current = 0; // Reset missed count after updating the state
      }
    }, 100);
  
    return () => {
      clearInterval(fallingIntervalRef.current);
      clearInterval(updateMissedIntervalRef.current);
    };
  }, []); // Run only once (handles strict mode correctly)
  ...
  const endGame = () => {
    ...
    const result = { score,wrongWord, missed, accuracy, wpm, total };
  ...
  return (
    <Container fluid className="game-container">
      ...
      <div className="top-bar">
        ...
        <div className="top-item">❌ Wrong: {wrongWord}</div>
