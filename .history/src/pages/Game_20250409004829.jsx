...
const Game = () => {
  ...
  const endGame = () => {
    // Delay to allow last state updates (like missed count) to register
    setTimeout(() => {
      ...
      console.log('Saving result to localStorage:', result); // DEBUG
      localStorage.setItem('gameResult', JSON.stringify(result));
  
      navigate('/gameover');
    }, 100); // Small delay (100ms) to ensure final state is accurate
  };
